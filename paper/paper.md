...
The first model we ued for text generation was a Markov Model. This approach is 
named for Russian mathemetician Andrey Markov, and it uses a chain of stochastic 
